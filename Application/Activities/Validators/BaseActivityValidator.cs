...
public class BaseActivityValidator<T, TDto> : AbstractValidator<T> 
    where TDto : BaseActivityDto // <-- this final constraint give access to the properties that CreateActivty and EditActivity (Dto?) have in common inside BaseActivityValidator
{
